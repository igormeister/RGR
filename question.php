    ...
    <div class="col-md-12 shadow p-3 mb-5 bg-white rounded">
      <div class="row" style="margin-bottom:10px; margin-top: 10px">
        ...
        <div class="col-md-12" style="text-align:center;min-height:100vh">
          <form action="system/addQuestion.php" method="POST">
            <div class="form-group">
              <label for="questionName">Input question name</label>
              <input type="text" class="form-control" id="questionName" name='title'>
            </div>
            <div class="form-group">
              <label for="questionTextarea">Enter question</label>
              <textarea class="form-control" id="questionTextarea" rows="25" name='code'></textarea>
            </div>
